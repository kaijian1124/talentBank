...
export const GRAPH_BUILD_SYSTEM = [
  ...
  'Edges connect node ids: every edge.from and edge.to MUST be the id of a node that is',
  'either in newNodes or in the existing graph summary. Do not invent ids.',
  '',
